...
Scenario: Creating a stripe pattern
  ...
  Then pattern.a = white
	And pattern.b = black
*/
TEST(stripe, should_have_a_b_colours_for_stripe_pattern)
{
	const colour_t black{ 0, 0, 0 };
	const colour_t white{ 1, 1, 1 };
	const Stripe stripe{ white, black };
...
*/
TEST(stripe, should_be_a_constant_colour_in_y)
{
	const colour_t black{ 0, 0, 0 };
	const colour_t white{ 1, 1, 1 };
	const Stripe stripe{ white, black };
...
*/
TEST(stripe, should_be_a_constant_colour_in_z)
{
	const colour_t black{ 0, 0, 0 };
	const colour_t white{ 1, 1, 1 };
	const Stripe stripe{ white, black };
...
*/
TEST(stripe, should_alternate_pattern_in_x)
{
	const colour_t black{ 0, 0, 0 };
	const colour_t white{ 1, 1, 1 };
	const Stripe stripe{ white, black };
...
Scenario: Stripes with an object transformation
  ...
  Then c = white
*/
TEST(stripe, should_work_with_object_transforms)
{
	const colour_t black{ 0, 0, 0 };
	const colour_t white{ 1, 1, 1 };
	const Stripe stripe{ white, black };
...
Scenario: Stripes with a pattern transformation
  ...
  Then c = white
*/
TEST(stripe, should_work_with_pattern_transforms)
{
	const colour_t black{ 0, 0, 0 };
	const colour_t white{ 1, 1, 1 };
...
Scenario: Stripes with both an object and a pattern transformation
  ...
  Then c = white
*/
TEST(stripe, should_work_with_pattern_and_object_transforms)
{
	const colour_t black{ 0, 0, 0 };
	const colour_t white{ 1, 1, 1 };
	Stripe stripe{ white, black };
